...
test.fork("d", () => {
...

  {
    ...
    const expected = new Float32Array([ 3, 3, 1, 1, 2, 2, 1, 1 ]);
  ...
  }
  {
    ...
    const expected = new Float32Array([ 3, 3, 1, 1, 1, 1, 1, 1 ]);
...
test.fork("child", () => {
  ...
  const synthdef = {
    ...
    units: [
      [ "DC"    , 2, 0, [ [ -1, 0 ]                       ], [ 2 ] ],
      [ "Dxrand", 3, 0, [ [ -1, 5 ], [ -1, 2 ], [ -1, 4 ] ], [ 3 ] ],
      [ "Dxrand", 3, 0, [ [ -1, 1 ], [ -1, 3 ], [  1, 0 ] ], [ 3 ] ],
...

  {
    ...
    const expected = new Float32Array([ 3, 3, 2, 2, 3, 3, 2, 2 ]);
