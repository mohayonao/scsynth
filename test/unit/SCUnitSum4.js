...
test("aaak", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + noise1[i] + noise2[i] + (noise3[0] * (i / 64));
    const expected = new Float32Array(nmap(64, calc));
...
test("aakk", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + noise1[i] + ((noise2[0] + noise3[0]) * (i / 64));
    const expected = new Float32Array(nmap(64, calc));
...
test("aaki", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + noise1[i] + (noise2[0] * (i / 64)) + noise3;
    const expected = new Float32Array(nmap(64, calc));
...
test("akkk", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + ((noise1[0] + noise2[0] + noise3[0]) * (i / 64));
    const expected = new Float32Array(nmap(64, calc));
...
test("akki", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + ((noise1[0] + noise2[0]) * (i / 64)) + noise3;
    const expected = new Float32Array(nmap(64, calc));
...
test("akii", () => {
...

  {
    ...
    const calc = (_, i) => noise0[i] + (noise1[0] * (i / 64)) + noise2 + noise3;
    const expected = new Float32Array(nmap(64, calc));
